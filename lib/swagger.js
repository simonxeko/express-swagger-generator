...
function parseSchema(obj) {
    ...
    if (obj.applications) {
        ...
        if (obj.applications.length === 1) {
            ...
            if (type == 'object' || type == 'string' || type == 'integer' || type == 'boolean' || type == 'date' || type == 'objectId') {
                return {
                ...
                if (example) {
                    switch (type) {
                        ...
                        case 'integer':
                            ...
                            break;
                        case 'objectId':
                            details.properties[propName].example = '507f191e810c19729de860ea';
                            break;
                        case 'date':
                            details.properties[propName].example = 'Tue Jul 07 2020 00:08:35 GMT+0800';
                            break;
                        case 'enum':
                            break;
                        default:
